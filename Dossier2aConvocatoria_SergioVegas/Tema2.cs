...
namespace Dossier2aConvocatoria_SergioVegas
{
    public class Tema2
    {
        ...
        public static void MenuT2()
        {
            ...
            {
                Console.WriteLine("\nMenú Principal:");
                Console.WriteLine("1. Factorial d’un número (iteratiu i recursiu) + nombre primer");
                Console.WriteLine("2. Introduir 10 números i calcular la mitjana, parells i senars");
                Console.WriteLine("3. Calcular l'àrea d’un rectangle");
                Console.WriteLine("4. Comprovar si un any és de traspàs");
                Console.WriteLine("5. Fer una divisió amb control d’excepcions");
                Console.WriteLine("6. Validar una contrasenya");
                Console.WriteLine("7. Validar una cadena amb 8 dígits seguits d’una lletra");
                Console.WriteLine("8. Comprovar quin dia de la setmana cau una data");
                Console.WriteLine("9. Comprovar si un número és positiu/negatiu i parell/senar");
                Console.WriteLine("10. Mostrar la taula de multiplicar d’un número");
                Console.WriteLine("11. Demanar 5 números i calcular la suma");
                Console.WriteLine("12. Retornar el quadrat d’un número");
                Console.WriteLine("13. Demanar un número entre 1 i 100");
                Console.WriteLine("14. Buscar un número dins un array de 10 números");
                Console.WriteLine("15. Guardar 5 paraules i mostrar-les en ordre invers");
                Console.WriteLine("16. Suma dels dígits d’un número enter");
                Console.WriteLine("17. Demanar 8 números i mostrar el més gran, el més petit i la mitjana");
                Console.WriteLine("18. Convertir una temperatura a Fahrenheit o Kelvin");
                Console.WriteLine("19. Joc d’endevinació d’un número entre 1 i 50");
                Console.WriteLine("20. Test de `IsEven(int num)` amb MsTest");
                Console.WriteLine("21. Test de `IsOdd(int num)` amb XUnit");
                Console.WriteLine("22. Millorar codi amb patrons de Clean Code");
                Console.WriteLine("23. Reescriure codi amb noms significatius");
                ...
                switch (option)
                {
                    case 1: Exercici5(); break;
                    case 2: Exercici6(); break;
                    case 3: CalculateRectangleArea(); break;
                    case 4: CheckLeapYear(); break;
                    case 5: Exercici8(); break;
                    case 6: Exercici9(); break;
                    case 7: Exercici10(); break;
                    case 8: Exercici11(); break;
                    case 9: Exercici12(); break;
                    case 10: Exercici13(); break;
                    case 11: Exercici14(); break;
                    case 12: Exercici15(); break;
                    case 13: Exercici16(); break;
                    case 14: Exercici17(); break;
                    case 15: Exercici18(); break;
                    case 16: Exercici19(); break;
                    case 17: Exercici20(); break;
                    case 18: Exercici21(); break;
                    case 19: Exercici22(); break;
                    case 20: Console.WriteLine(IsEven(CheckInputs.CheckValidNumber())); break;
                    case 21: Console.WriteLine(IsOdd(CheckInputs.CheckValidNumber())); break;
                    case 22: Exercici25(); break;
                    case 23: Exercici26(); break;
                    case 0: Console.WriteLine("Has sortit del programa."); break;
                    default: Console.WriteLine("Opció no vàlida! Torna-ho a intentar."); break;
                }
            } while (option != 0);
        }
